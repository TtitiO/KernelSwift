...
调试手段：`T.printf`、`T.dump_tensor`、`get_kernel_source()`，详见 [TileLang-Ascend programming documentation](https://github.com/tile-ai/tilelang-ascend/tree/272c0ab3928df30f84d7ac644456856366ff60c4/docs)。

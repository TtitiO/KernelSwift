...
- **代码审查检查项**：使用项目内 `ascendc-operator-code-review` 或 `kernelswift-a2-kernel-dev` 的 review/validation gates；CANNBot's original workflow reference is not vendored.

...
2. 查阅 `.agents/skills/tilelang-api-best-practices/SKILL.md` 确认 API 可用性和用法
3. 查阅 `.agents/skills/tilelang-programming-model-guide/SKILL.md` 确认编程模式和 pass_configs 配置
...
| 2 | `.agents/skills/tilelang-api-best-practices/SKILL.md` | API 速查 | 快速确认 |
| 3 | `testing/python/language/` | 边界用法和测试模式参考 | 测试参考 |
| 4 | **外部参考实现** | **仅用于理解数学逻辑** | **不可直接使用 API** |
| 5 | `.agents/skills/tilelang-programming-model-guide/SKILL.md` | 模式选择 | 辅助决策 |
